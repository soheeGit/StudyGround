...
const { getBoardData, getMyBoardData, partBoardsData, postBoardData, postApplyBoard, applyList, postAcceptBoard, postRejectBoard, acceptBoardEnter } = require('../controllers/page');
...
// 스터디 신청 목록
router.get('/applyList', isLoggedIn, applyList)
